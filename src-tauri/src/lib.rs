...
pub use codex_config::{
    codex_config_has_official_proxy_route, extract_codex_experimental_bearer_token,
...
pub fn run() {
    ...
    let builder = builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::read_codex_instructions_file,
            commands::write_codex_instructions_file,
            commands::delete_codex_instructions_file,
